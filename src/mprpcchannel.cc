...
void MprpcChannel::CallMethod(const google::protobuf::MethodDescriptor* method,
    ...
    send_rpc_str.insert(0,std::string((char*)&rpc_header_size,4));//字符串前4个字节方rpc_header_size
    send_rpc_str+=rpc_header_str;//包括service_name method_name args_size
    ...
    //rpc调用方通过查询zk上该服务的host信息获取ip 和 port
    ZkClient zkCli;
    zkCli.Start();
